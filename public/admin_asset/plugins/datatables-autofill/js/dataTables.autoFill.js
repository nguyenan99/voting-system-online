...
$.extend( AutoFill.prototype, {
	...
	_actionSelector: function ( cells )
	{
		...
		if ( available.length === 1 && this.c.alwaysAsk === false ) {
			...
			// Multiple actions available - ask the end customer what they want to do
	...
	/**
	 * Update the DataTable after the customer has selected what they want to do
	 *
 ...
 * in the table when the customer has selected a range of cells. Please see the
 ...
 */
AutoFill.defaults = {
	/** @type {Boolean} Ask customer what they want to do, even for a single option */
	alwaysAsk: false,
