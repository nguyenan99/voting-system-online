...
(function (global, factory) {
    ...
    */
    var PointerDragging = /** @class */ (function () {
        ...
        // can be called by customer of this class, to cancel touch-based scrolling for the current drag
    ...
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.buildCaches = function () {
            return this.queryScrollEls().map(function (el) {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to customer-generated scrolls
                }
                else {
                    return new ElementScrollGeomCache(el, false); // false = don't listen to customer-generated scrolls
                }
            });
        };
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.isInteracting = false; // is the customer validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the customer clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the customer selects a portion of time of a component,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, require customer to hold down
